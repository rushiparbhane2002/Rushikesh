...
const Skills = () => {
  return (
    <div className="px-16 mx-20 my-5 font-mono xs-mx:px-5 xs-mx:mx-5" id="Skills">
      {/* <h1 className="text-4xl sm:text-3xl xs:text-2xl mb-16 font-bold text-center text-white">
